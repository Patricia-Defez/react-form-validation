...
export default class Form extends Component {
  ...
  render = () => {
    let color = 'input'
    if (this.state.touch && !this.state.error) {
      color = 'input' + ' ' + 'is-success';
    } else if(this.state.touch && this.state.error) {
      ...
      <form className="Form" onSubmit={this.onSubmit}>
        <div className="field">
          ...
          <div className="control has-icons-left has-icons-right">
            <input className={color} type="email" name="email" placeholder="User email" value={this.state.email}
